...
Премиум члены получают процентный кэшбэк с каждой комиссии за транзакцию, которую они оплачивают, и имеют право получать реферальный доход от пользователей, которых они регистрируют, или рефереров сети. Премиум подписка подразумевает единоразовую оплату, размер которой определяется комитетом.
