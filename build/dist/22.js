    ...
    [22, 43],
    {
        ...
        359: function(e, t, a) {
            ...
            (N.defaultProps = {noSymbols: !1}),
                (N.contextTypes = {router: S.a.object.isRequired});
            var O = Object(g.a)(N, {
        ...
        4981: function(e, t, a) {
                            ...
                            value: function() {
                                ...
                                var I = new he.a({
                                    ...
                                    R = C
                                        ...
                                        : 0,
                                    L = de.a.getFlagBooleans(
                                        o.getIn(["options", "flags"]),
                                        o.has("bitasset_data_id")
                                    ),
                                    D = de.a.getFlagBooleans(
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                if (P.length > 0 && T.length > 0) {
                                    var M = (T[0][0] + P[P.length - 1][0]) / 2;
                                    (F.xAxis.min = 0.4 * M),
                                        (F.xAxis.max = 1.6 * M),
                                        F.xAxis.max < T[0][0] &&
                                            (F.xAxis.max = 1.5 * T[0][0]),
                                        F.xAxis.min > P[P.length - 1][0] &&
                                            (F.xAxis.min =
                                                0.5 * P[P.length - 1][0]);
                                    var j = 0;
                                    ...
                                    F.yAxis.labels.formatter = function() {
                                ...
                                return (
                                    ...
                                    this.props.height
                                        ? (F.chart.height = this.props.height)
                                        : (F.chart.height = "400px"),
                                    this.props.onClick &&
                                        (F.chart.events = {
            ...
            st.propTypes = {account: le.a.ChainAccount.isRequired};
            var ot = (st = Object(ce.a)(st)),
                it = (function() {
                    function e(e, t) {
                        for (var a = 0; a < t.length; a++) {
                            var n = t[a];
            ...
            !(function(e) {
                function t(e) {
                    ...
                    return (
                        ...
                        (a.chooseAsset = a.chooseAsset.bind(a)),
                        (a.closeModal = a.closeModal.bind(a)),
                        new xt.a().getAllowCurrency(function(t) {
                ...
                (function(e, t) {
                    ...
                    St(t, [
                        ...
                        {key: "loadAssetCourse", value: function(e) {}},
                        {
                            key: "chooseAsset",
                            value: function(e) {
                                var t = this.findCurrentCurrency(e);
                                this.setState({
                                    asset: e,
                                    confirmations: this.getCountConfirmations(
                                        e
                                    ),
                                    minimal: t ? t.minimal : 0
                                }),
                                    this.loadAssetCourse(e);
                            }
                        },
                        {
                        ...
                        {key: "updateReceive", value: function() {}},
                        {
                            key: "_onAmountChange",
                            value: function(e, t) {
                                ...
                                a.test(n.value) ||
                                    ...
                                    n.value.charAt(n.value.length) !=
                                        n.value.search(".") &&
                                        n.value.substr(1),
                                    (n.value = utils.limitByPrecision(
                                        n.value,
                                        8
                                    )),
                                    console.log(n.value);
                ...
                return (
                    ...
                    Mt(t, [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                var e = Ot.Apis.instance().chain_id;
                                return (
                                    "lastMarket" +
                                    (e ? "_" + e.substr(0, 8) : "")
                                );
                        ...
                        },
                        {
                            ...
                            value: function(e, t, a) {
                                ...
                                var p = u(i, c, this.state.sellFeeAssetIdx),
                                    h = p.assets,
                                    m = p.asset,
                                    d = u(l, c, this.state.buyFeeAssetIdx),
                                    f = d.assets,
                                    g = d.asset;
                                return {
                                    sellFeeAsset: m,
                                    sellFeeAssets: h,
                                    sellFee: this._getFee(m),
                                    buyFeeAsset: g,
                                    buyFeeAssets: f,
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                Oe &&
                                    ...
                                    (Pe = de.a.parseDescription(Pe).main));
                                var Te = !1;
                                L < 1e3 && ((Te = !0), (F = !1));
                                var Ie = F ? 2 : 1,
                                    Be = (Math.max(
                                    ...
                                    this.state.expirationType),
                                    Fe = this.state.expirationCustomTime,
                                    Me = W
                                        ? null
                        ...
                        zt(t, [
                            {
                                ...
                                value: function() {
                                    ...
                                    null !== this.props.quoteAsset &&
                                        ...
                                        Jt.on(
                                            "cancel-order",
                                            (Gt = b.a.cancelLimitOrderSuccess)
                                        ),
                                        Jt.on(
                                            "close-call",
                                            (Qt = b.a.closeCallOrderSuccess)
                                        ),
                                        Jt.on(
                                            "call-order-update",
                                            (Yt = function(t) {
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    null !== t &&
                                        ...
                                        Jt &&
                                            (Jt.off("cancel-order", Gt),
                                            Jt.off("close-call", Qt),
                                            Jt.off("call-order-update", Yt),
                                            Jt.off("bitasset-update", Kt),
                                            Jt.off("settle-order-update", Xt)));
                                }
                            },
                            {
                                key: "_subToMarket",
            ...
            (Zt.propTypes = {
                ...
                (Zt = Object(ce.a)(Zt, {show_loader: !0}));
            t.default = Vt;
        },
        790: function(e, t, a) {
            !(function(e) {
