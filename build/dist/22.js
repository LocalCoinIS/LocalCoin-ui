(window.webpackJsonp = window.webpackJsonp || []).push([
    [22],
    {
        ...
        360: function(e, t, n) {
            ...
            te.defaultProps = {maxRows: 20, onlyLiquid: !1};
            var ne = (function(e) {
                function t(e) {
                    Z(this, t);
                    var n = $(
                    ...
                    Y(t, [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return {baseGroups: b, otherMarkets: g};
                            }
                        },
                        {
                            key: "_getBases",
            ...
            (ne.defaultProps = {activeTab: "my-market", setMinWidth: !1}),
                (ne = z()(ne, 50, {leading: !1}));
            var ae = (function(e) {
                function t() {
                    return (
                        Z(this, t),
                    ...
                    Y(t, [
                        {
                            key: "render",
                            value: function() {
                                return s.a.createElement(ne, this.props);
                            }
                        }
                    ]),
                    t
            ...
            t.a = Object(f.connect)(ae, {
                listenTo: function() {
                    return [B.a, A.a, q.a];
                },
                getProps: function() {
                    return {
                        starredMarkets: B.a.getState().starredMarkets,
                        onlyLiquid: B.a
                            .getState()
                            .viewSettings.get("onlyLiquid", !0),
                        defaultMarkets: B.a.getState().defaultMarkets,
                        viewSettings: B.a.getState().viewSettings,
                        preferredBases: B.a.getState().preferredBases,
                        marketStats: A.a.getState().allMarketStats,
                        userMarkets: B.a.getState().userMarkets,
                        searchAssets: q.a.getState().assets,
                        onlyStars: A.a.getState().onlyStars,
                        assetsLoading: q.a.getState().assetsLoading
                    };
                }
            });
        },
