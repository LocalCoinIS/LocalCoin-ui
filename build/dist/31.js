                    ...
                    I(t, [
                        {
                            ...
                            value: function(e) {
                                ...
                                if (t.collateral) {
                                    var a = _.a.get_asset_amount(
                                            t.debt,
                                            e.quote_asset
                                        ),
                                        n = _.a.get_asset_amount(
                                            t.collateral,
                                            e.backing_asset
                                        );
                                    return {
                        ...
                        },
                        {
                            ...
                            value: function(e, t) {
                                return !(
                                    _.a.are_equal_shallow(t, this.state) &&
                                    j.a.is(
                                        e.quote_asset,
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                e.preventDefault(),
                                    u.a.publish(this.props.modalId, "close");
                            }
                        },
                        {
                            key: "_onBorrowChange",
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                parseFloat(e.collateral) - a.collateral >
                                    _.a.get_asset_amount(
                                        n.balance,
                                        this.props.backing_asset.toJS()
                                    ) &&
                                    (t.collateral_balance = N.a.translate(
                                ...
                                (this._isPredictionMarket(this.props) ? 1 : o)
                                    ? ((t.below_maintenance = N.a.translate(
                                          "borrow.errors.below",
                                          {mr: o}
                                      )),
                                      (r = !1))
                                    : parseFloat(e.collateral_ratio) <
                                          (this._isPredictionMarket(this.props)
                                              ? 1
                                              : o + 0.5) &&
                                      ((t.close_maintenance = N.a.translate(
                                          "borrow.errors.close",
                                          {mr: o}
                                      )),
                                      (r = !0)),
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                e.preventDefault();
                                var t = _.a.get_asset_precision(
                                        this.props.quote_asset.get("precision")
                                    ),
                                    a = _.a.get_asset_precision(
                                        this.props.backing_asset.get(
                                            "precision"
                                        )
                                    ),
                                    n = this._getCurrentPosition(this.props),
                                    r = O.a.new_transaction();
                        ...
                        },
                        {
                            ...
                            value: function() {
                                var e = this,
                                    ...
                                    p = i.errors,
                                    d = i.isValid,
                                    m = _.a.get_asset_precision(
                                        this.props.quote_asset.get("precision")
                                    ),
                                    b = _.a.get_asset_precision(
                                        this.props.backing_asset.get(
                                            "precision"
                                        )
                                    );
                                ...
                                var g = E()("form-group", {
                                    ...
                                    A = this._getCurrentPosition(this.props),
                                    x = o.id ? T.b.getObject(o.id) : null,
                                    P =
                                        (x ? x.get("balance") : 0) -
                                        parseInt(
                    ...
                    I(t, [
                        {
                            ...
                            value: function() {
                                ...
                                this.setState({open: !0}, function() {
                                    u.a.publish(e.props.modalId, "open");
                                });
                            }
                        },
                        {
