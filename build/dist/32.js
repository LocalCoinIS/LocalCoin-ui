                        ...
                        },
                        {
                            ...
                            value: function() {
                                var e =
                                    ...
                                    t = e.base,
                                    a = e.quote;
                                N.a.getMarketStats(t, a),
                                    (this.statsChecked = new Date()),
                                    (this.statsInterval = setInterval(
                                        N.a.getMarketStats.bind(this, t, a),
                                        35e3
                                    ));
                            }
                        },
                            ...
                            value: function() {
                                ...
                                var u = (function(e) {
                                        ...
                                        if (
                                            ...
                                            return t;
                                        var a = e.get("symbol").split(".");
                                        return 2 === a.length ? a[1] : a[0];
                                    })(a),
                                    d = n
                                        ? parseFloat(n.change) > 0
                                            ? "change-up"
                                            : parseFloat(n.change) < 0
                                                ? "change-down"
                                                : ""
                                        : "",
                                    h = a.get("symbol") + "_" + t.get("symbol"),
                        ...
                        P(t, [
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this.setState({showFlip: t, markets: a});
                                }
                            },
                            {
            ...
            var z = (function(e) {
                function t() {
                    ...
                    var e,
                        ...
                        o = u.Apis.instance().chain_id;
                    return (
                        o && (o = o.substr(0, 8)),
                        (r.state = {chainID: o, markets: []}),
                        (r.marketsByChain = ((e = {}),
                        (a = r.state.chainID),
                        (n = [
                            ["USD", "LLC"],
                    ...
                    V(t, [
                        {
                            ...
                            value: function() {
                                var e = this.props,
                                    ...
                                    n = e.accountsReady,
                                    o = e.passwordAccount;
                                if (!n) return r.a.createElement(l.a, null);
                                if (!(t.size + a.size + (o ? 1 : 0)))
